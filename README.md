...
**Server / worker updates:** pull `ghcr.io/teguva/coog:0.1.34` and recreate Compose, or pull the repo and re-run `./deploy/install-linux.sh`, then `systemctl --user restart coog-api coog-worker`.
